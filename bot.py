...
def auto_select_menu(fmt: str, guests: int, food_budget: float, target_weight: int) -> list:
    ...
    REQUIRED_CATS = {
        "Фуршет": {
            ...
            "тарталетки":       {"portions_total": 2, "varieties": 3, "keywords": ["тарталетки", "вонтон", "такос", "треугольники"]},
            "брускетта":        {"portions_total": 2, "varieties": 2, "keywords": ["мини-брускетта", "брускетта", "чиабатта"]},
            "мини-салаты":      {"portions_total": 1, "varieties": 2, "keywords": ["мини-салаты", "салаты", "салат"]},
            "горячие закуски":  {"portions_total": 1, "varieties": 2, "keywords": ["горячие закуски"]},
            "горячее":          {"portions_total": 1, "varieties": 2, "keywords": ["горячее", "карвинг горячее"]},
            "десерты":          {"portions_total": 2, "varieties": 3, "keywords": ["десерт", "десерт банкетный", "выпечка"]},
            "напитки холодные": {"portions_total": 3, "varieties": 2, "keywords": ["прохладительные напитки"]},
            "напитки горячие":  {"portions_total": 1, "varieties": 1, "keywords": ["горячие напитки"]},
        },
        "Банкет": {
            "закуски":          {"portions_total": 1, "varieties": 2, "keywords": ["закуски"]},
            "салаты":           {"portions_total": 1, "varieties": 2, "keywords": ["салаты", "мини-салаты"]},
            "горячее":          {"portions_total": 1, "varieties": 2, "keywords": ["горячее", "карвинг горячее"]},
            "десерты":          {"portions_total": 2, "varieties": 2, "keywords": ["десерт банкетный", "десерт"]},
            "напитки холодные": {"portions_total": 3, "varieties": 2, "keywords": ["прохладительные напитки"]},
            "напитки горячие":  {"portions_total": 1, "varieties": 1, "keywords": ["горячие напитки"]},
        },
        "BBQ": {
            "bbq":              {"portions_total": 3, "varieties": 3, "keywords": ["ввq", "bbq"]},
            "допы bbq":         {"portions_total": 1, "varieties": 2, "keywords": ["допы ввq", "допы bbq"]},
            "салаты":           {"portions_total": 1, "varieties": 2, "keywords": ["салаты", "мини-салаты"]},
            "десерты":          {"portions_total": 1, "varieties": 2, "keywords": ["десерт", "выпечка"]},
            "напитки холодные": {"portions_total": 3, "varieties": 2, "keywords": ["прохладительные напитки"]},
            "напитки горячие":  {"portions_total": 1, "varieties": 1, "keywords": ["горячие напитки"]},
        },
    }
